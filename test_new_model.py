...
#from new_model import VanillaNeRFRadianceField, get_embedder, get_rays, precompute_quadratic_samples, sample_pdf, compute_depth_loss, select_coordinates
import new_model as new_model
#from new_model import NerfMLP
...
old_mlp = old_model.NeRF(input_ch_cam=4)
new_mlp = new_model.mlp.NerfMLP(input_ch_cam=4)
...
#     """
#     embed_fn, input_ch = old_model.get_embedder(args.multires, args.i_embed)

#     input_ch_views = 0
#     embeddirs_fn = None
#     if args.use_viewdirs:
#         embeddirs_fn, input_ch_views = old_model.get_embedder(args.multires_views, args.i_embed)
#     output_ch = 5 if args.N_importance > 0 else 4
#     skips = [4]

#     model = old_model.NeRF(D=args.netdepth, W=args.netwidth,
...
# def create_nerf_new_model(args, scene_render_params, other_model):
#     """Instantiate NeRF's MLP model.
#     """
#     print(new_model.get_embedder(args.multires, args.i_embed))
#     embed_fn, input_ch = new_model.get_embedder(args.multires, args.i_embed)

#     input_ch_views = 0
#     embeddirs_fn = None
#     if args.use_viewdirs:
#         embeddirs_fn, input_ch_views = new_model.get_embedder(args.multires_views, args.i_embed)
#     output_ch = 5 if args.N_importance > 0 else 4
#     skips = [4]

#     model = new_model.VanillaNeRFRadianceField(i_train=i_train, args=args, device=device)
...
#     model_fine = None
#     # if args.N_importance > 0:
#     #     model_fine = VanillaNeRFRadianceField(itrain=0, args)
...
#     model.D = other_model.D
#     model.W = other_model.W
#     model.input_ch = other_model.input_ch
#     model.input_ch_views = other_model.input_ch_views
#     model.input_ch_cam = other_model.input_ch_cam
#     model.skips = other_model.skips
#     model.use_viewdirs = other_model.use_viewdirs
#     model.pts_linears = other_model.pts_linears
#     model.views_linears = other_model.views_linears
#     model.feature_linear = other_model.feature_linear
#     model.alpha_linear = other_model.alpha_linear
#     model.rgb_linear = other_model.rgb_linear
#     model.output_linear = other_model.output_linear
#     # End set weights
...
#     # create nerf model
#     render_kwargs_train, render_kwargs_test, start, nerf_grad_vars, optimizer, model1 = create_nerf(args, scene_sample_params)
#     render_kwargs_train, render_kwargs_test, start, nerf_grad_vars, optimizer, model2 = create_nerf_new_model(args, scene_sample_params, model1)

#     # Test nerf model using random input
#     print('I managed to create the two nerfs')
